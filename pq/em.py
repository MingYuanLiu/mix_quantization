...
class EM():
    ...
    def step(self, in_activations, in_activations_eval, M, i):
        ...
        # assignments (E-step)
        distances = self.compute_distances(in_activations)  # (n_centroids x out_features), the shape of centroids is (9,)
        ...
        while len(empty_clusters) > 0:
            ...
            self.centroids[k] += e
            self.centroids[m] -= e
            print('empty cluster numbers: ', len(empty_clusters))

            # recompute assignments (E-step)
